...
<header class="site-header">
    <div id="desk">
        ...
        <nav>
            ...
            <li><button class="button" onclick="window.location.href='../../views/administrador/nuevo_grupo.html'">Registrar grupo</button></li>
    ...
    <div class="container">
        ...
        <table class="table table-striped" bgcolor="3FABAF";>
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                // Consulta para buscar el grupos por nombre (búsqueda parcial)
                $sql = "SELECT id_grupo, nombre FROM grupos WHERE nombre LIKE '%$nombre_buscada%'";
                ...
                if ($result->num_rows > 0) {
                    ...
                    echo "<tr><td colspan='7'>No se encontraron grupos.</td></tr>";
                }
            }
