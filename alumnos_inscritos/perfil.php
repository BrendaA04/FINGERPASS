...
if (isset($_SESSION['matricula']) && isset($_SESSION['nombre']) && isset($_SESSION['apellido1']) && isset($_SESSION['apellido2'])) {
    ...
    header('Location: login_nuevos.php');
    exit;
}
...
// Consulta SQL para obtener el ID y nombre del grupo del estudiante
$sql_grupo = "SELECT G.nombre AS nombre_grupo FROM estudiantes_inscritos EI JOIN grupos G ON EI.id_grupo = G.id_grupo WHERE EI.matricula='$matricula'";
...
if ($resultado_grupo->num_rows > 0) {
    ...
    // Asignar el nombre del grupo a la variable $nombre_grupo
    $nombre_grupo = $fila_grupo['nombre_grupo'];
} else {
    // Manejar el caso en que no se encuentre el grupo del estudiante
    ...
    <div class="content">
        ...
        <div id="profile-container">
            <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="POST">
                ...
                <div>
                    <label for="nombre_grupo" style="color: white;">Grupo:</label>
